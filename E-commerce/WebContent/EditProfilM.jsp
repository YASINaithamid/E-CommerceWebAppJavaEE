                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <form action="editerprofilM" method="post">
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                    	<div class="mb-3 row">
    										...
    										<div class="col-sm-10">
      											<input type="text" class="form-control" id="inputname" name="Nom" value="<%=Marchand.getNom() %>">
    										</div>
  										</div>
  										<div class="mb-3 row">
    										<label for="inputname" class="col-sm-2 col-form-label">PRENOM :</label>
    										<div class="col-sm-10">
      											<input type="text" class="form-control" id="inputname" name="Prenom" value="<%=Marchand.getPrenom() %>">
    										</div>
  										</div>
  										<div class="mb-3 row">
    										<label for="inputname" class="col-sm-2 col-form-label">ADRESSE :</label>
    										<div class="col-sm-10">
      											<input type="text" class="form-control" id="inputname" name="Adress" value="<%=Marchand.getAdress() %>">
    										</div>
  										</div>
  										<div class="mb-3 row">
    										<label for="inputname" class="col-sm-2 col-form-label">EMAIL :</label>
    										<div class="col-sm-10">
      											<input type="email" class="form-control" id="inputemail" name="Email" value="<%=Marchand.getEmail() %>">
    										</div>
  										</div>
                                    	<div class="mb-3 row">
