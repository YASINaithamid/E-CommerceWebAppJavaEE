            ...
            <div class="row">
              ...
              <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12 pl-0" style="border-left:1px solid grey">
                <div class="container large-right-sider">
                  ...
                  <%for(int i=0;i<ProductsT.size();i+=4){ %>
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6  text-center">
                       <a href="Product.jsp?id=<%= String.valueOf((ProductsT.get(i)).getproduit_id())%>"><img src=<%= (ProductsT.get(i)).getimg()%> class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"></a> 
                       <p></p>
                       <a href="Product.jsp?id=<%= String.valueOf((ProductsT.get(i)).getproduit_id())%>"><span class="image-lable" data-aos="fade-up"><%= (ProductsT.get(i)).getname()%><br><%= (ProductsT.get(i)).getprix()%> MAD</span></a>
                    </div>
                    <%if(i+1<ProductsT.size()){ %>
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6  text-center">
                      <a href="Product.jsp?id=<%= String.valueOf((ProductsT.get(i+1)).getproduit_id())%>"><img src=<%= (ProductsT.get(i+1)).getimg()%> class="img-men" data-aos="fade-up" style="height:180px"><br></a>
                      <p></p>
                      <a href="Product.jsp?id=<%= String.valueOf((ProductsT.get(i+1)).getproduit_id())%>"><span class="image-lable" data-aos="fade-up"><%= (ProductsT.get(i+1)).getname()%><br><%= (ProductsT.get(i+1)).getprix()%> MAD</span></a>
                    </div>
                    <%}; %>
                    <%if(i+2<ProductsT.size()){ %>
                    <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-tablate">
                      <a href="Product.jsp?id=<%= String.valueOf((ProductsT.get(i+2)).getproduit_id())%>"><img src=<%= (ProductsT.get(i+2)).getimg()%> class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"></a>
                      <p></p>
                      <a href="Product.jsp?id=<%= String.valueOf((ProductsT.get(i+2)).getproduit_id())%>"><span class="image-lable" data-aos="fade-up"><%= (ProductsT.get(i+2)).getname()%><br><%= (ProductsT.get(i+2)).getprix()%> MAD</span></a>
                    </div>
                    <%}; %>
                    <%if(i+3<ProductsT.size()){ %>
                    <div class="col-xl-3 col-lg-3 col-md-3 text-center hide-containt-small-device">
                      <a href="Product.jsp?id=<%= String.valueOf((ProductsT.get(i+3)).getproduit_id())%>"><img src=<%= (ProductsT.get(i+3)).getimg()%> class="img-men" data-aos="fade-up" style="height:180px"><br></a>
                      <p></p>
                      <a href="Product.jsp?id=<%= String.valueOf((ProductsT.get(i+3)).getproduit_id())%>"><span class="image-lable" data-aos="fade-up"><%= (ProductsT.get(i+3)).getname()%><br><%= (ProductsT.get(i+3)).getprix()%> MAD</span></a>
                    </div>
                    <%}; %>
                  <%}; %>
                  </div>
