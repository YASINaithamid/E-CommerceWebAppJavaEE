                ...
                <div class="container-fluid">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Nouvelles Commandes</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                		...
                                		<table class="table table-bordered" id="dataTable" style="width: 100%;cellspacing: 0">
                                    		...
                                    		<%for(int i = 0; i < tableCommandesM.size(); i++){ %>
                                        		<tr>
		                                            ...
		                                            <td><a href="ConfirmerCommandeM.jsp?id_Com=<%= (tableCommandesM.get(i)).getcommande_id() %>">Confirmer</a></td>
		                                        </tr>
		                                    <%}; %>
		                                   	</tbody>
                                		</table>
