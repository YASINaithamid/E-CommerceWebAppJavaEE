...
tableCommandesM=commandes.recuperercommandes_M(String.valueOf(session.getAttribute( "id_m" )),"livrée"); 
                ...
                <div class="container-fluid">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Commandes Livrées</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
