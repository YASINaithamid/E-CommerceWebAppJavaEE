...
<html>
    <head>
        ...
        <title>Online Store - Contactez nous</title>
    </head>
    <body style="background-image:url('Images/login-background.jpg');background-size: cover;">
        <div class="container">
            <div class="container form bg-white pt-5 mt-4 mb-3">
                <p class="text-center contact-heading">Contactez Nous</p>
                <div class="container">
                    <div class="row pl-5 pt-3">
                        ...
                        <div class="col-12 pt-5">
                            <a href="Index.jsp"><span class="btn text-white send-button" style="width:85%">envoyer</span></a>
                        </div>
                    </div>
                </div>
            </div>
